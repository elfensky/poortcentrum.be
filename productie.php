...
<head>
	...
	<!-- SEO  -->
	<title>Productie | Technologie | Info | Poortcentrum</title>
	<meta name="description" content="Informatie over hoe wij te werk gaan, da manier van lassen, de materialen en gebruikte technologie">
	<link rel="canonical" href="https://poortcentrum.be/productie" />
</head>
	...
	<section id="manufacturing" class="o-section c-about__section" data-section-name="troeven">
		...
		<div class="o-padding-wrapper">
			<article class="c-about__section__content">
				<h2 class="c-about__section__content__title">PRODUCTIE</h2>
